...
// type NoUndefinedField<T> = T extends object ? { [P in keyof T]-?: NoUndefinedField<NonNullable<T[P]>> } : T
    ...
    <div className='py-4'>
        ...
        {categories.map((categoryItem) => {
          ...
          return (
            <li className='py-2 pl-2' key={categoryItem._id}>
              ...
              >
                {isActive && (
                  <svg viewBox='0 0 4 7' className='h-2 w-2 fill-orange absolute top-1 left-[-10px]'>
      ...
      <div className='my-5'>
        ...
        <form className='mt-2' onSubmit={onSubmit}>
              ...
              render={({ field }) => {
                return (
                  <InputNumber
                    ...
                    className='grow'
                    name='from'
                    classNameInput='px-1 py-1 text-sm w-full outline-none border border-gray-300 focus:border-gray-500 rounded-sm focus:shadow-sm'
                    placeholder='đ TỪ'
                    onChange={(event) => {
          ...
          <div
            className='
          mt-1 text-red-600 min-h-[1.25rem] text-sm text-center
